...
Скриншот big.png При этом итоговый размер всеравно не совпадает (браузер отваливается по ошибке
...
Ошибка исчезла все грузится нормально скриншот big_print.png